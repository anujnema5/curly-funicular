...
draft: false
summary: Reach within by Circus maximus Guitar, Piano and Ukulele chords, Chords used - (E) (G#m) (B) (G#) (C#m) (F#) (C#) (D#m) ,  Key - G# Major.
images: ['/thumbnails/reach-within-circus-maximus.jpg']
layout: PostLayout
authors: ['junaidalam']
---
...
![Reach within Guitar Chords by Circus maximus](/thumbnails/reach-within-circus-maximus.jpg)
...
**(C#)** Life in a re **(G#m)** flection **(E)** **(D#)** **(F#)**\ 
There comes a **(G#m)** time when we need the **(E)** answers **(F#)**
